...
object LLMConfigs {
    // Qwen (阿里云)
    fun qwenPlus(apiKey: String) = LLMClient(
        apiKey = apiKey,
        baseUrl = "https://dashscope.aliyuncs.com/compatible-mode/v1",
        model = "qwen-plus"
    )

    fun qwenMax(apiKey: String) = LLMClient(
        apiKey = apiKey,
        baseUrl = "https://dashscope.aliyuncs.com/compatible-mode/v1",
        model = "qwen-max"
    )
    ...
    // OpenAI GPT-4
    fun gpt4(apiKey: String) = LLMClient(
        apiKey = apiKey,
        baseUrl = "https://api.openai.com/v1",
        model = "gpt-4"
    )

    fun gpt35Turbo(apiKey: String) = LLMClient(
        apiKey = apiKey,
        baseUrl = "https://api.openai.com/v1",
        model = "gpt-3.5-turbo"
    )
    ...
    fun custom(apiKey: String, baseUrl: String, model: String) = LLMClient(
        apiKey = apiKey,
        baseUrl = baseUrl,
        model = model
    )
